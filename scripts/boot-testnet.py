...
def initGenesis(nodeNum):
    ...
    node(mainChainSymbol,
         'genesis add-coin %s \"%s\"' % (coreCoin(1000000000000000000000000000000000000000), "main core"))
    node(mainChainSymbol, 'genesis add-account-coin %s %s' % (mainAuth, coreCoin(100000000000000000000000000000000)))
    node(mainChainSymbol,
         'genesis add-account-coin %s %s' % (mainChainSymbol, coreCoin(100000000000000000000000000000000)))
...
def mkNodeDatas(name, num, totalNum):
    if name is not mainChainSymbol:
        ...
        run('cp %s/config/genesis.json %s/config/genesis.json' % (
            getNodeHomePath(mainChainSymbol), getNodeHomePath(name)))
